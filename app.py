    ...
    # Temporarily comment out fine_tune_model if it's causing issues,
    # but keep predict_fraud and load_ngo_darpan_data
    from fraud_detection import predict_fraud, load_ngo_darpan_data, load_fraud_detection_model # Removed fine_tune_model here as it's not called directly at startup anyway
